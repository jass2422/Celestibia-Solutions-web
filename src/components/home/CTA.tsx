      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
            Let's create something extraordinary together. Contact us to discuss how we can help you leverage cloud
            technology for efficiency, agility, and new possibilities.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Button variant="hero" size="xl" asChild onClick={handleCTAClick}>
              <Link to="/contact" className="flex items-center gap-2">
                {ctaButton.isLoading ? "Schedule a Consultation" : ctaButton.getVariantValue()}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-muted-foreground">
            <a href="mailto:info@celestibia.com" className="flex items-center gap-2 hover:text-coral transition-colors">
              <Mail className="w-5 h-5" />
              info@celestibia.com
            </a>
            <a href="tel:+918308535810" className="flex items-center gap-2 hover:text-coral transition-colors">
