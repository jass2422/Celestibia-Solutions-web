...
const cloudSecurityFeatures = [
  ...
  },
  {
    ...
    description:
      "Zero Trust Architecture, Identity and Access Management (IAM), Network segmentation and firewall policies.",
  },
  {
    icon: Fingerprint,
  ...
  },
  {
    ...
    description:
      "Static and dynamic code analysis (SAST/DAST). Shift-left security in CI/CD pipelines. Container security (Trivy, Aqua, Prisma Cloud).",
  },
];
...
const cybersecurityFeatures = [
  ...
  },
  {
    ...
    description:
      "SIEM implementation (Splunk, ELK, AWS GuardDuty). 24/7 monitoring and threat detection. Incident handling and forensic analysis.",
  },
  {
    icon: Eye,
    ...
    <main className="min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              Security is at the core of everything we do. We provide comprehensive security solutions covering both
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">☁️ Cloud Security</h2>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">🔐 Cybersecurity</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">Compliance Frameworks</h2>
            <p className="text-muted-foreground">We help you achieve and maintain compliance with industry standards</p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">Our Security Approach</h2>
              <p className="text-muted-foreground text-lg mb-8">
                We follow a defense-in-depth strategy that combines preventive, detective, and responsive controls to
                protect your assets.
              </p>
